<html>
<head><title>Weather Report of <?php echo $_GET['city_name']; ?> - HackerRahul.com</title>
...
$city = $_GET['city_name'];
 $string = "http://api.openweathermap.org/data/2.5/weather?city_name=".$city."&units=metric&appid=ebcf5230b3446f334fe3fa2fd2d4ce24";
